    ...
    <footer className="bg-black text-gray-400 py-10 mt-auto">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="flex space-x-6 mt-6">
          ...
          <a href="https://helloitsmyportfolio.netlify.app/" className="text-red-600  hover:text-white hover:scale-130 transition duration-500 ">
            Portfolio
          </a>
          <a href="https://itsmycarrental.netlify.app/" className="text-red-600  hover:text-white hover:scale-130 transition duration-500 ">
           <Folder/> Projects
          </a>
